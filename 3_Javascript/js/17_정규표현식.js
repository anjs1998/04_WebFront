...
document.querySelector("#btn2").addEventListener("click", () => {
    ...
    div1.innerHTML += "/[abcd]/, ssbss : " + regExp1.test("apple") + "<hr>";
    div1.innerHTML += "/[abcd]/, qwerty : " + regExp1.test("apple") + "<hr>";
    // ^ (캐럿)
...
document.getElementById("InputPno").addEventListener("keyup", (e) =>{
    ...
    if(e.target.value.length == 0){
        ...
        span.classList.remove("confirm, error"); // js레벨에서 클래스 삭제 confirm, error
        return;
