...
// 매개변수로 요소 전달하기
function btn2bFn(el){
    //매개변수 el( element )의 줄임말 : 이벤트가 발생한 요소
...
arrowList[1].addEventListener("click", e => { //매개변수 1개면 괄호 뺴도 무방
...
arrowList[2].addEventListener("click", e => { //매개변수 1개면 괄호 뺴도 무방
...
arrowList[3].addEventListener("click", e => { //매개변수 1개면 괄호 뺴도 무방
